...
from exercises.L3_exercise_3_subdag import get_s3_to_redshift_dag
...
trips_subdag_task = SubDagOperator(
    subdag=get_s3_to_redshift_dag(
        ...
        "aws_credentials",
        "trips",
        sql_statements_exercises.CREATE_TRIPS_TABLE_SQL,
...
stations_subdag_task = SubDagOperator(
    subdag=get_s3_to_redshift_dag(
        ...
        "aws_credentials",
        "stations",
        sql_statements_exercises.CREATE_STATIONS_TABLE_SQL,
        s3_bucket="udacity-dend",
